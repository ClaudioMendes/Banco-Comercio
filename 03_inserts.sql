...
insert into PedidoItem (CodigoPedido, CodigoProduto, Preco, Quantidade) values (2, 1, 1.50, 2)
insert into PedidoItem (CodigoPedido, CodigoProduto, Preco, Quantidade) values (3, 1, 20.99, 3)
